...
public class D4_7_2_1 : Dialogue{
	...
	public void Enter(){	
		...
		buttons.buttonGirl = 	"Quelle belle proposition! Moi qui n'avait justement pas" + "\n" + 
								"envie de me faire à manger!";
	}
	...
	public void Execute(int choice){
		...
		switch(choice){
		case 0:
			DialogueManager.getDialogueManager().changeDialogue(new D4_8()); 		// change dialogue
			break;
		}
