...
public class D2_13_2 : Dialogue{
	...
	public void Enter(){
		...
		buttons.buttonGuy = 	"Pas question, je..." + "\n" + 
								"";
		
		// less relationship points...
	...
	public void Execute(int choice){
		...
		case 0:
			DialogueManager.getDialogueManager().changeDialogue(new D2_13_2_1()); 		// change dialogue
			break;
