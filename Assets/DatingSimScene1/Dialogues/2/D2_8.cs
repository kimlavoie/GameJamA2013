...
public class D2_8 : Dialogue{
	...
	public void Enter(){
		...
		buttons.buttonGirl = 	"La prochaine fois que tu m'ignores comme ça, ne t'attends" + "\n" + 
								"pas à ce que je sois encore autant de bonne humeur!";
	...
	public void Execute(int choice){
		...
		case 0:
			DialogueManager.getDialogueManager().changeDialogue(new D2_9()); 		// change dialogue
			break;
