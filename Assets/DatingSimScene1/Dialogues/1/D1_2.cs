...
public class D1_2 : Dialogue{
	...
	public void Enter(){
		...
		buttons.buttonGuy = 	"À chaque fois que je crois avoir découvert le pire du" + "\n" + 
								"genre humain, il réussit toujours à me surprendre.";
	...
	public void Execute(int choice){
		...
		case 0:
			DialogueManager.getDialogueManager().changeDialogue(new D1_3()); 		// change dialogue
			break;
