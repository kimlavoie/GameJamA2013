...
public class D1_7 : Dialogue{
	...
	public void Enter(){
		...
		buttons.buttonGuy = 	"Je préfère de loin m'autoproclamer reclus, que d'avoir" + "\n" + 
								"à me fondre dans cette masse superficielle et insipide.";
	...
	public void Execute(int choice){
		...
		case 0:
			DialogueManager.getDialogueManager().changeDialogue(new D1_8()); 		// change dialogue
			break;
