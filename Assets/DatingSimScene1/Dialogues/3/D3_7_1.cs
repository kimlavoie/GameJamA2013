...
public class D3_7_1 : Dialogue{
	...
	public void Enter(){
		...
		buttons.buttonGuy = 	"On pourrait aller au restaurant." + "\n" + 
								"";
	}
	...
	public void Execute(int choice){
		...
		case 0:
			//Perdre des points
			DialogueManager.getDialogueManager().changeDialogue(new D3_7_1_1()); 		// change dialogue
			break;
