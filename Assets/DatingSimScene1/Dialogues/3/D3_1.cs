...
public class D3_1 : Dialogue{
	...
	public void Enter(){
		...
		buttons.buttonGirl = 	"Bon, je vais y aller, bonne soirée!" + "\n" + 
								"";
	}
	...
	public void Execute(int choice){
		...
		// Example
		case 0:
			DialogueManager.getDialogueManager().changeDialogue(new D3_2()); 		// change dialogue
			break;
