...
public class D3_7_3 : Dialogue{
	...
	public void Enter(){
		...
		buttons.buttonGuy = 	"On pourrait aller marcher dans le parc." + "\n" + 
								"";
	}
	...
	public void Execute(int choice){
		...
		case 0:
			//Perdre des points
			DialogueManager.getDialogueManager().changeDialogue(new D3_7_3_1()); 		// change dialogue
			break;
