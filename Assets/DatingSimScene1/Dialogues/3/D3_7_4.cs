...
public class D3_7_4 : Dialogue{
	...
	public void Enter(){
		...
		buttons.buttonGuy = 	"On pourrait aller prendre un verre." + "\n" + 
								"";
	}
	...
	public void Execute(int choice){
		...
		case 0:
			//Gagner des points
			DialogueManager.getDialogueManager().changeDialogue(new D3_7_4_1()); 		// change dialogue
			break;
